...
module.exports = function (grunt) {
    ...
    var JS_DIR = 'public/js/app',
        ...
        PROJECT_ID = 'onlinestore' || 'defaultproj',
        CLIENT_ID = 'U2E1Yiwrx26ldRlLLERbiMMIE6CXhRTM' || 'hkpWzlQnCIe4MSTi1Ud94Q7O36aRrRrO',
        REDIRECT_URI = grunt.option('ruri') || 'http://127.0.0.1:9000',
        PROJECT_ID_PATH = './public/js/app/shared/app-config.js',
        PROD_DOMAIN = 'api.stage.yaas.io',
